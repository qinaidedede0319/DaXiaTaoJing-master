    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-lg-offset-1">
            <div class="col-lg-4">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <a class="item" href="/people/qin-ai-de-a-ji-mi-de/followees">
            ...
            <div class="col-lg-4">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <a class="item" href="/people/qin-ai-de-de-de/followers">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-header">
                    <a href="/people/qin-ai-de-a-ji-mi-de">亲爱的阿基米德</a>
                    » 编辑个人资料
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="zm-profile-side-section-title">
                        关注了 <a href="/people/qin-ai-de-a-ji-mi-de/topics" class="zg-link-litblue"><strong>14 个话题</strong></a>
                    </div>
                </div>
            </div>
